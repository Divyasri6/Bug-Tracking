    ...
    <div className="min-h-screen bg-gray-100">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* AI Assistant Panel Placeholder - Takes 1 column on large screens */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg border-2 border-dashed border-purple-200 p-6">
              <div className="text-center py-8">
                <div className="text-purple-600 text-4xl mb-3">🤖</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">AI Assistant</h3>
                <p className="text-sm text-gray-500">
                  AI-powered bug resolution suggestions will appear here
                </p>
              </div>
            </div>
          </div>
